...
"${ARDUINO_APP_PATH}/Contents/Resources/Java/hardware/tools/avr/bin/avrdude" "-C${ARDUINO_APP_PATH}/Contents/Resources/Java/hardware/tools/avr/etc/avrdude.conf" "-p${MCU}" "-P${PORT}" "-c${PROTOCOL}" "-b${UPLOAD_RATE}" -D "-Uflash:w:${BUILD_DIR}/${PRODUCT_NAME}.hex:i"
